...
object Lab9{
  def main(args: Array[String]){
		...
		studied(0)=Flip(0.5)
		for{ i <- 1 until nrCapitole} { studied(i) = If(studied(i-1),Flip(0.5),Flip(0.2)) }
		...
		booleanMark(1).observe(false)
		booleanMark(2).observe(true)
		booleanMark(3).observe(true)
		booleanMark(4).observe(true)
		println("Probability to pass boolean test 10: " + VariableElimination.probability(booleanMark(9),true))

		booleanMark(1).observe(true)
		booleanMark(2).observe(true)
		booleanMark(3).observe(false)
		booleanMark(4).observe(true)
		booleanMark(5).observe(true)
		booleanMark(6).observe(true)
		booleanMark(7).observe(true)
		booleanMark(8).observe(true)
		println("Probability to pass boolean test 10: " + VariableElimination.probability(booleanMark(9),true))
