...
alg5.start()
println("Probabilitatea ca aceasta sa se intample este :" + alg5.probability(player1Card,6) * alg5.probability(player2Card,4) * alg5.probability(player1Bet1,true) * alg5.probability(player2Bet,true))

println("Probabilitatea ca aceasta sa se intample este :" + alg5.probability(player1Card,3) * alg5.probability(player2Card,1) * alg5.probability(player1Bet1,false) * alg5.probability(player2Bet,false))

println("Probabilitatea ca aceasta sa se intample este :" + alg5.probability(player1Card,2) * alg5.probability(player2Card,4) * alg5.probability(player1Bet1,false) * alg5.probability(player2Bet,true))
